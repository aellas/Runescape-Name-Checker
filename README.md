# 🔎 RSNChecker
<strong>RSNChecker</strong> is an open source project that allows you to search either OSRS, RS3 hiscores or RunePixels. You can search a single username or enter multiple usernames.
