# 🔎 RSNChecker
<strong>RSNChecker</strong> allows you to search OSRS, RS3 hiscores or RunePixels to see if a username is available. <br />
You can search either a single username, or multiple usernames (seperated by a comma)
<br /> 
