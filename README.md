...
+ Note: When using Mutli Search, if you search for more then 20 or so usernames, the GUI will stop responding, let it do it's thing and it will show the results.
<br />
